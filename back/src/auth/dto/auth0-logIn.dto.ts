...
export class Auth0LogInDto {
  ...
  @ApiProperty({
    description: 'Url de la imagen de perfil del usuario correspondiente a la cuenta de google', 
    example: 'https://static.wikia.nocookie.net/wowpedia/images/5/50/Priest_Crest.png/revision/latest?cb=20151110144724',
    type: String,
  })
  @IsOptional()
  @IsString()
